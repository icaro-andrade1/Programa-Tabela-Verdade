...
char **instanciandoTabelaVerdade(char **tabelaVerdade, int *c, int *l, char *formula)
{
	...
	tamTabVerdade++; // mais um devido ao cabeÃ§alho

	//apÃ³s obter o tamanho da tabela instancia
	...
	//entÃ£o preenche o cabeÃ§alho da tabela com as letras
